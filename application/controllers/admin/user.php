...
class User extends Admin_Controller 
{
    ...
    public function edit($id = NULL)
	{
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            $data = $this->user_m->array_from_post(array('name_surname', 'password', 'username', 'research_sms_notifications',
                                                         'address', 'description', 'mail', 'phone','age','gender','phone2', 'type', 
               ...
               isset($data['password'])*/)
            {
                ...
                $this->email->from($this->data['settings']['noreply'], 'Udora');
    ...
    public function forgetpassword()
    {
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            $this->email->from($this->data['settings']['noreply'], lang_check('reset password'));
            $this->email->to($data['mail']);
            $this->email->subject(lang_check('reset password'));
    ...
    public function verifyemail($user_id = NULL, $hash = NULL)
    {
        ...
        else
        {
            ...
            $this->data['message'] = '<p class="label label-info validation">'.lang_check('Thank you, email verified and account activated!').'</p>';
