<div class="page-title">
    <div class="title_left">
        <h3><?php echo lang('Estate Options')?></h3>
    </div>
...
<div class="x_panel">
    ...
    <div class="x_content">
     <?php echo anchor('admin/estate/edit_option', '<i class="icon-plus"></i>&nbsp;&nbsp;'.lang('Add a option'), 'class="btn btn-primary-blue"')?>
    </div>
</div>
<!-- /Add page / events button -->
...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Estate Options')?></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li class="dropdown">
...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang_check('Frequently asked questions')?></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li class="dropdown">
