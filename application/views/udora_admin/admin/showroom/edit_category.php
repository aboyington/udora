<div class="page-title">
    <div class="title_left">
        <h3><?php echo lang_check('Category')?></h3>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo empty($showroom->id) ? lang('Add a category') : lang('Edit category').' "' . $showroom->id.'"'?></h2>
...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="page-files-box" id="page-files-<?php echo $showroom->id?>" rel="page_m">
                <!-- The file upload form used as target for the file upload widget -->
                <form class="fileupload" action="<?php echo site_url('files/upload/'.$showroom->id);?>" method="POST" enctype="multipart/form-data">
