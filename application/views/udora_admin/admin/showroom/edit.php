<div class="page-title">
    <div class="title_left">
        <h3><span class="page-meta"><?php echo empty($showroom->id) ? lang_check('Add showroom') : lang_check('Edit showroom').' "' . $showroom->id.'"'?></span></h3>
    </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Showroom data')?></h2>
                               ...
                               <div style="margin-bottom: 0px;" class="tabbable">
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a href="<?php echo site_url('admin/showroom')?>" class="btn btn-danger" type="button"><?php echo lang('Cancel')?></a>
                                  </div>
                                </div>
                       <?php echo form_close()?>
            </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="page-files-box" id="page-files-<?php echo $showroom->id?>" rel="estate_m">
                <!-- The file upload form used as target for the file upload widget -->
                <form class="fileupload" action="<?php echo site_url('files/upload_estate/'.$showroom->id);?>" method="POST" enctype="multipart/form-data">
                    <!-- Redirect browsers with JavaScript disabled to the origin page -->
                    <noscript><input type="hidden" name="redirect" value="<?php echo site_url('admin/page/edit/'.$showroom->id);?>"></noscript>
