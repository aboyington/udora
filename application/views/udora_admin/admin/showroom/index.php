...
<div class="x_panel">
    ...
    <div class="x_content">
 <?php echo anchor('admin/showroom/edit', '<i class="icon-plus"></i>&nbsp;&nbsp;'.lang_check('Add showroom'), 'class="btn btn-primary-blue"')?>
    </div>
</div>
<!-- /Add page / events button -->
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang_check('View all showrooms')?></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li class="dropdown">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <?php if(check_acl('showroom/delete')):?><th class=""><?php echo lang('Delete');?></th><?php endif;?>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo btn_edit_udora('admin/showroom/edit/'.$news_post->id)?></td>
                        <?php if(check_acl('showroom/delete')):?><td><?php echo btn_delete_udora('admin/showroom/delete/'.$news_post->id)?></td><?php endif;?>
                    </tr>
                    <?php endforeach;?>
                    <?php else:?>
                    <tr>
