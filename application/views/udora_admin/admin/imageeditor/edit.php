...
<html>
  <head>
    ...
    <link href="<?php echo base_url('adminudora-assets/css/bootstrap.css')?>" rel="stylesheet">
    
    <script src="<?php echo base_url('adminudora-assets/js/cropit/jquery.min.js')?>"></script>
    <script src="<?php echo base_url('adminudora-assets/js/cropit/jquery.cropit.js')?>"></script>
  ...
  <body>
    ...
    <div class="col-sm-offset-2 col-sm-5">
      <button type="submit" class="btn btn-primary-blue"><?php _l('Save'); ?></button>
    </div>
  </div>
