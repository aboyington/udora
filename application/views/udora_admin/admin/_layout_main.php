                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        ...
                        <div class="profile_info">
                            <span><?php echo lang_check('Welcome back');?></span>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'estate')!==FALSE || strpos($this->uri->uri_string(),'reports')==TRUE || strpos($this->uri->uri_string(),'treefield')==TRUE)?' active':'';?>">
                                  ...
                                  <ul class="nav child_menu">
                                    <li>
                                      <a href="<?php echo site_url('admin/estate')?>"><?php echo lang_check('Manage');?></a>
                                    </li>
                                    <?php if(check_acl('estate/options')):?>
                                    <li>
                                      <a href="<?php echo site_url('admin/estate/options')?>"><?php echo lang_check('Fields');?></a>
                                    </li>
                                    <li>
                                      <a href="<?php echo site_url('admin/estate/dependent_fields')?>"><?php echo lang_check('Dependent fields');?></a>
                                    </li>
                                    <?php endif;?>
                                    <?php if(check_acl('estate/forms') && config_item('search_forms_editor_enabled') == TRUE):?>
                                    <li>
                                      <a href="<?php echo site_url('admin/estate/forms')?>"><?php echo lang_check('Search forms');?></a>
                                    </li>
                                    <?php endif;?>
                                    ...
                                    <li class="<?php echo (strpos($this->uri->uri_string(),'enquire')!==FALSE)?' current-page':'';?>">
                                      <a href="<?php echo site_url('admin/enquire')?>"><?php echo lang_check('Inquires');?></a>
                                    </li>
                                    <?php endif;?>
                                ...
                                <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                                    ...
                                    <li class="<?php echo (strpos($this->uri->uri_string(),'user')!==FALSE && strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))===FALSE)?' current-page':'';?>">
                                      <a href="<?php echo site_url('admin/user')?>"><i class="fa fa-users"></i><?php echo lang_check('Agents & Users');?></a>
                                    </li>
                                <?php endif;?>
                                ...
                                <?php if(config_item('admin_beginner_enabled') === TRUE):?> 
                                    <li class="<?php echo (strpos($this->uri->uri_string(),'statistics')!==FALSE)?' active':'';?>">
                                      <a><i class="fa fa-bar-chart-o"></i><?php echo lang_check('Analytics');?><span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                ...
                                <li class="">
                                    <a href="https://email.udora.io" target="_blank"><i class="fa fa-money"></i><?php echo lang_check('Marketing');?></a>
                                </li>
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'packages')!==FALSE)?' active':'';?>">
                                    <a><i class="fa fa-gift"></i><?php echo lang_check('Packages');?><span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'packages')!==FALSE)?' current-page':'';?>">
                                    <a href="<?php echo site_url('admin/packages/mypackage')?>"><i class="fa fa-gift"></i> <?php echo lang_check('My package');?></a>
                                </li>
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'packages')!==FALSE)?' ccurrent-page':'';?>">
                                    <a href="<?php echo site_url('admin/packages/affilatepackage'); ?>"><i class="fa fa-gift"></i> <?php echo lang_check('Affilate package');?></a>
                                </li>
                                <?php endif;?>          
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'monetize')!==FALSE)?' active':'';?>">
                                    <a><i class="fa fa-dollar"></i><?php echo lang_check('Payments');?><span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'showroom')!==FALSE)?' activr':'';?>">
                                    <a><i class="fa icon-briefcase"></i><?php echo lang_check('Showroom');?><span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'expert')!==FALSE)?' active':'';?>">
                                    <a><i class="fa icon-comment"></i><?php echo lang_check('Q&A');?><span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'booking')!==FALSE)?' active':'';?>">
                                    <a><i class="fa icon-shopping-cart"></i><?php echo lang_check('Booking');?><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'tcalendar')!==FALSE)?' active':'';?>">
                                    <a><i class="fa icon-calendar"></i><?php echo lang_check('TCalendar');?><span class="fa fa-chevron-down"></span></a>
                                  <ul class="nav child_menu">
                                ...
                                <li class="">
                                    <a href="#"><i class="fa icon-filter"></i><?php echo lang_check('Extra');?><span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">                                                         
                                        <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                                        <li class="<?php echo (strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))!==FALSE)?' current-page':'';?>">
                                            <a href="<?php echo site_url('admin/user/edit/'.$this->session->userdata('id'))?>"><?php echo lang_check('Profile');?></a>
                                        </li>
                                        <?php endif;?>
                                        ...
                                        <li class="<?php echo (strpos($this->uri->uri_string(),'savesearch')!==FALSE)?' current-page':'';?>">
                                            <a href="<?php echo site_url('admin/savesearch')?>"><?php echo lang_check('Research');?></a>
                                        </li>
                                        <?php endif; ?>
                                        ...
                                        <li class="<?php echo (strpos($this->uri->uri_string(),'ads')!==FALSE)?' current-page':'';?>">
                                            <a href="<?php echo site_url('admin/ads')?>"><?php echo lang_check('Ads');?></a>
                                        </li>
                                        <?php endif;?>

                                        <?php if(check_acl('slideshow')):?>
                                        <li class="<?php echo (strpos($this->uri->uri_string(),'slideshow')!==FALSE)?' current-page':'';?>">
                                            <a href="<?php echo site_url('admin/slideshow')?>"><?php echo lang_check('Slideshow')?></a>
                                        </li>
                                        <?php endif;?>

                                        <?php if(check_acl('backup')):?>
                                        <li class="norange<?php echo (strpos($this->uri->uri_string(),'backup')!==FALSE)?' current-page':'';?>">
                                            <a href="<?php echo site_url('admin/backup')?>"><?php echo lang_check('Backup')?></a>
                                        </li>
                                        <?php endif;?>                               
                                      </ul>
                                </li>
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'mapreport')!==FALSE)?' current-page':'';?>">
                                    <a href="<?php echo site_url('admin/mapreport')?>"><i class="fa icon-bar-chart"></i><?php echo lang_check('Map report');?></a>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="<?php echo (strpos($this->uri->uri_string(),'benchmarktool')!==FALSE)?' current-page':'';?>">
                                    <a href="<?php echo site_url('admin/benchmarktool')?>"><i class="fa icon-fire"></i><?php echo lang_check('Benchmark tools');?></a>
                                </li>
                                <?php endif; ?> 
                              
                                <li class="">
                                    <a href="https://udora.io/support/login/" target="_blank"><i class="fa icon-fire"></i><?php echo lang_check('Support Center');?></a>
                                </li>
                                 
                                <?php if(config_item('admin_beginner_enabled') === TRUE && check_acl('settings')):?>
                                    <li class="<?php echo (strpos($this->uri->uri_string(),'settings')!==FALSE)?' active':'';?>">
                                      <a><i class="fa fa-gears"></i><?php echo lang_check('Settings');?><span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                    ...
                    <div class="sidebar-footer hidden-small">
                        <a data-toggle="tooltip" data-placement="top" title="Settings" href="<?php echo site_url('admin/settings')?>">
