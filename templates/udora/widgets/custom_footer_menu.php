<div class="footer style-1 d-md-none js-hide-when-navbar-open js-hide-when-login-open">
    <div class="footer-links">
        ...
        {is_logged_user}
            <a href="<?php echo site_url('frontend/myproperties/'.$lang_code.'#content');?>" class="footer-links__link">
        ...
        {/is_logged_other}
        {not_logged}
            <a href="<?php echo site_url('frontend/myproperties/'.$lang_code.'#content');?>" class="footer-links__link js-toggle-login-popup js-close-mobile-navbar">
                <i class="fa fa-user"></i>
                <span class="footer-links__link__title">{lang_Profile}</span>
            </a>
        {/not_logged}
