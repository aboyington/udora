<div class="footer style-1 d-md-none js-hide-when-navbar-open js-hide-when-login-open">
    <div class="footer-links">
        {is_logged_user}
                ...
                <a href="<?php echo site_url('/' . $lang_code . '#content'); ?>"
                   class="footer-links__link">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" width="25px" viewBox="0 0 29.07 22.54"><defs><style>.cls-1{fill:#f15a24;}</style></defs><title>logo icon</title><g id="Layer_2" data-name="Layer 2"><g id="Foreground_Layer" data-name="Foreground Layer"><path class="cls-1" d="M7.37,22.54A7.34,7.34,0,0,1,0,15.18V0H2.6V15.18a4.77,4.77,0,0,0,9.54,0V4.27h2.6V15.18A7.34,7.34,0,0,1,7.37,22.54Z"/><path class="cls-1" d="M17.34,22.54V19.85c4.34,0,9-3.69,9-8.64s-4.2-8.64-9.23-8.64H4.34V0H17.12c6.53,0,12,4.83,12,11.27S23.41,22.54,17.34,22.54Z"/></g></g></svg>
        ...
        {not_logged}
                ...
                <a href="<?php echo site_url('/frontend/login/' . $lang_code . '#content'); ?>"
                   class="footer-links__link">
                    <i class="material-icons">favorite_border</i>
                    <span class="footer-links__link__title">{lang_Saved}</span>
                </a>
