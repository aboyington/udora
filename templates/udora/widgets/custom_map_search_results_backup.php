        ...
        <div class="form search-form inputs-underline">
            <form>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="search_option_smart" value="{search_query}" id="search_option_smart" placeholder="<?php echo lang_check('Search event name or word');?>">
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input type="text" class="text-left" id="search_option_81_82" name="daterange" value="" placeholder="<?php echo lang_check('Date range');?>"/>
                        </div>
                        <!--end form-group-->
                    </div>
                </div>
