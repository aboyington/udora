                    ...
                    $.each(data.results, function(index, listing) {
                      if( typeof listing.latLng !== 'undefined'){
                        var marker = new google.maps.Marker({
                            ...
                            var markerContent =
                            '<div class="marker" data-id="'+marker_id+'">' +
...
//                        );
  ...
  /* additionals for map */  
    ...
    function AddControl(controlDiv2, map) {
        ...
        controlUI.title = '<?php echo lang_check('Submit a location');?>';
        ...
        controlText.innerHTML = '<strong><?php echo lang_check('Submit a location');?></strong>';
