...
<div class="raw">
    <div class="text-center col-xs-12 col-sm-6 col-lg-12 blog-sidebar-share">
        ...
        <a href="https://plus.google.com/share?url={page_current_url}" class="btn btn-social-icon btn-google-plus" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="ion-social-googleplus-outline"></i></a>
