...
/*>>fastclick*/
 _checkInstance(); })(window.jQuery || window.Zepto);if (!$('#blueimp-gallery').length)
...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.applyClass = 'accent-button';
        this.cancelClass = 'no-radius';
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var arrow = this.locale.direction == 'ltr' ? {left: 'ion-ios-arrow-left', right: 'ion-ios-arrow-right'} : {left: 'ion-ios-arrow-left', right: 'ion-ios-arrow-right'};
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="' + arrow.left + ' ' + arrow.left + '"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class=" ' + arrow.right + ' ' + arrow.right + '"></i></th>';
            } else {
                html += '<th></th>';
            }
