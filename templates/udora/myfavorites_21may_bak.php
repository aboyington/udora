                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body left-align">
                            <div class="form-estate">
                                     ...
                                     <thead>
                                         <th>#</th>
                                         <th data-breakpoints="xs sm md" data-type="html"><?php echo lang_check('Event');?></th>
<!--                                          <th data-breakpoints="xs sm md" data-type="html" ><?php echo lang_check('Language');?></th> -->
                                         ...
                                         <th data-breakpoints="xs sm md" data-type="html" ><?php echo lang_check('Feedback');?></th>
                                         <?php endif;?>   
                                             ...
                                             <td>
                                                <?php
                                                    ...
                                                    if($CI->reviews_m->check_if_exists($this->session->userdata('id'), $listing_item->property_id) !== 0 ) {
                                                        $class= ' disabled';
                                                        $message = lang_check('You already have review on this event');
                                                        $data = '';
                                                    }
                                                    ...
                                                    if(config_db_item('events_qr_confirmation') === TRUE && $CI->userattend_m->check_notattend($listing_item->property_id, 
                                                        ...
                                                        $class= ' disabled';
                                                        $data = '';
                                                        $message = lang_check('You can review after attend on event');
                                                    }
                                                ?>
                                                <div type="button" <?php echo $data;?> data-message="<?php _jse($message);?>"  data-listing_id="<?php echo $listing_item->property_id; ?>" class="open-leave-review <?php echo $class;?>">
                                                    <?php echo lang_check('Leave a Review');?>
                                                </div>
                                             </td>
                                             <?php endif;?>   
                                             <td>
                                             <a href="<?php echo site_url($listing_uri.'/'.$listing_item->property_id.'/'.$listing_item->lang_code); ?>" class="btn btn-primary no-margin"><i class="icon-white icon-search"></i><?php echo lang_check('Open');?></a>
                                             </td>
